...
export function KpiCards({ revenue, expenses, toReceive, toPay, alerts }: KpiCardsProps) {
  const profit = revenue - expenses;
  const cards = [
    { title: "Receita do Mês", value: revenue, icon: ArrowDownLeft, color: "text-success" },
    { title: "Despesas do Mês", value: expenses, icon: ArrowUpRight, color: "text-destructive" },
